...
struct sample::draw_call_text::impl {
    ...
    void prepare(sample::draw_call_text_ptr const &text) {
...
void sample::draw_call_text::_prepare(draw_call_text_ptr const &shared) {
