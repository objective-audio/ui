...
- (void)test_update_scale_action {
    ...
    XCTAssertEqual(target.scale().value().x, 0.0f);
    XCTAssertEqual(target.scale().value().y, -1.0f);

    updatable.update(time + 500ms);

    XCTAssertEqual(target.scale().value().x, 0.5f);
    XCTAssertEqual(target.scale().value().y, 0.0f);

    updatable.update(time + 1s);

    XCTAssertEqual(target.scale().value().x, 1.0f);
    XCTAssertEqual(target.scale().value().y, 1.0f);
}
...
- (void)test_update_color_action {
    ...
    XCTAssertEqual(target.color().value()[0], 0.0f);
    XCTAssertEqual(target.color().value()[1], 0.25f);
    XCTAssertEqual(target.color().value()[2], 0.5f);

    updatable.update(time + 500ms);

    XCTAssertEqual(target.color().value()[0], 0.5f);
    XCTAssertEqual(target.color().value()[1], 0.5f);
    XCTAssertEqual(target.color().value()[2], 0.5f);

    updatable.update(time + 1s);

    XCTAssertEqual(target.color().value()[0], 1.0f);
    XCTAssertEqual(target.color().value()[1], 0.75f);
    XCTAssertEqual(target.color().value()[2], 0.5f);
}
