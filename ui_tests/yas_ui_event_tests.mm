...
- (void)test_phase {
    ...
    event->set_phase(ui::event_phase::began);
...
- (void)test_is_equal_event {
    ...
    cursor_event->set<ui::cursor>(ui::cursor_event{{.v = 0.0f}, 10.0});
    touch_event1->set<ui::touch>(ui::touch_event{1, {.v = 0.0f}, 10.0});
    touch_event2->set<ui::touch>(ui::touch_event{1, {.v = 0.0f}, 11.0});
    touch_event3->set<ui::touch>(ui::touch_event{2, {.v = 0.0f}, 12.0});
...
- (void)test_cursor_event_accessor {
    ...
    event->set<ui::cursor>(ui::cursor_event{{0.5f, 1.5f}, 100.0});
...
- (void)test_touch_event_accessor {
    ...
    event->set<ui::touch>(ui::touch_event{11, {2.5f, 3.5f}, 200.0});
...
- (void)test_key_event_accessor {
    ...
    event->set<ui::key>(ui::key_event{23, "4", "5", 300.0});
...
- (void)test_modifier_event_accessor {
    ...
    event->set<ui::modifier>(ui::modifier_event{ui::modifier_flags::command, 400.0});
