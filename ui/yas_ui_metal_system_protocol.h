...
struct renderable_metal_system : protocol {
    struct impl : protocol::impl {
        ...
        virtual void push_render_target(ui::render_stackable &, ui::render_target_ptr const &) = 0;
    };
    ...
    void push_render_target(ui::render_stackable &, ui::render_target_ptr const &);
};
