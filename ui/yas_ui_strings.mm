...
std::string const &ui::strings::text() const {
    return impl_ptr<impl>()->_text.value();
}
...
chaining::chain_syncable_t<std::string> ui::strings::chain_text() const {
    return impl_ptr<impl>()->_text.chain();
}

chaining::chain_syncable_t<ui::font_atlas> ui::strings::chain_font_atlas() const {
    return impl_ptr<impl>()->_font_atlas.chain();
}

chaining::chain_syncable_t<opt_t<float>> ui::strings::chain_line_height() const {
    return impl_ptr<impl>()->_line_height.chain();
}

chaining::chain_syncable_t<ui::layout_alignment> ui::strings::chain_alignment() const {
