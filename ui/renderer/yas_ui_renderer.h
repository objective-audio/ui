...
struct renderer final : view_renderer_interface {
    ...
    [[nodiscard]] static std::shared_ptr<renderer> make_shared(std::shared_ptr<ui::renderer_system_interface> const &,
   ...
   private:
    ...
    std::shared_ptr<ui::renderer_system_interface> _system;
    ...
    renderer(std::shared_ptr<ui::renderer_system_interface> const &, std::shared_ptr<ui::renderer_view_look> const &,
