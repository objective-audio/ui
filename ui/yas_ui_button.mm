...
struct ui::button::impl : base::impl {
    ...
    void setup_renderer_observer() {
        ...
        _renderer_observer = node.subject().make_observer(
            ...
            [event_observer = base{nullptr}, leave_observer = base{nullptr}, weak_button = to_weak(cast<ui::button>())](
    ...
    states_t _states;
    ui::rect_plane_extension _rect_plane_ext = ui::make_rect_plane_extension(ui::button::state_count * 2, 1);
...
ui::rect_plane_extension &ui::button::rect_plane_extension() {
